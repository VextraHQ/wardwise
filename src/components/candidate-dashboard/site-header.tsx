    ...
    <header className="bg-background/95 supports-backdrop-filter:bg-background/60 sticky top-0 z-50 flex h-(--header-height) shrink-0 items-center gap-2 border-b backdrop-blur transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-(--header-height)">
      <div className="flex w-full items-center gap-2 px-3 sm:gap-3 sm:px-4 lg:gap-4 lg:px-6">
          ...
          {isResolving ? (
            <div className="flex animate-pulse flex-col gap-0.5">
              <div className="flex min-w-0 items-center gap-1.5 overflow-hidden sm:gap-2">
                ...
                <div className="bg-muted/30 h-4 w-32 shrink-0 rounded sm:w-36" />
              </div>
              <div className="bg-muted/20 hidden h-3 w-28 rounded md:block" />
            </div>
          ) : (
            <div className="flex min-w-0 flex-col gap-0.5">
              ...
              <p className="text-muted-foreground hidden truncate font-mono text-[10px] font-bold tracking-widest uppercase md:block">
        ...
        <div className="ml-auto flex items-center gap-1.5 sm:gap-2">
          <div className="border-primary/20 bg-primary/5 hidden items-center gap-1.5 rounded-sm border px-2 py-0.5 sm:inline-flex">
