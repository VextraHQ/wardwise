      ...
      <CardContent className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
        <div className="min-w-0 space-y-3">
          ...
          <Button
            size="sm"
            variant="ghost"
            className="text-muted-foreground hover:text-foreground -ml-2 h-8 rounded-sm font-mono text-[10px] font-bold tracking-widest uppercase"
          ...
          <p className="text-muted-foreground text-[11px] leading-none">
            Protected report • This device stays unlocked for 24 hours.
          </p>
        </div>

        <div className="flex shrink-0 flex-col items-end text-right sm:border-l sm:pl-6">
