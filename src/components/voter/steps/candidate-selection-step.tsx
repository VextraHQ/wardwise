            ...
            <div className="border-border/40 mb-8 border-b pb-6">
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Badge
                  ...
                  className="gap-1.5 text-[9px] font-bold tracking-wider uppercase"
                >
                  {isComplete ? (
                  ...
                  <div className="flex items-start gap-3 rounded-lg border border-amber-200/60 bg-amber-50 p-4 dark:border-amber-900/30 dark:bg-amber-950/10">
                    ...
                    <div className="flex-1 space-y-1 pt-0.5">
                      ...
                      <p className="text-xs leading-relaxed text-amber-800/90 dark:text-amber-200/80">
                        We're only showing positions with registered candidates
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="bg-muted/5 pr-9 pl-9 font-medium"
                  />
                  {searchTerm && (
                    <button
                      type="button"
                ...
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex flex-wrap items-center gap-2 sm:gap-3">
                    ...
                    >
                      <SelectTrigger className="bg-muted/5 h-9 w-full text-[10px] font-bold tracking-wider uppercase sm:w-[160px]">
                    ...
                    >
                      <SelectTrigger className="bg-muted/5 h-9 w-full text-[10px] font-bold tracking-wider uppercase sm:w-[180px]">
