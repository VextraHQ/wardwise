        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-start lg:justify-between">
          ...
          <div className="grid gap-6 sm:grid-cols-3 lg:gap-8">
            <div className="flex items-start gap-2.5">
              <HiShieldCheck className="text-primary mt-0.5 h-5 w-5 flex-shrink-0" />
              <div>
            ...
            <div className="flex items-start gap-2.5">
              <HiEye className="text-primary mt-0.5 h-5 w-5 flex-shrink-0" />
              <div>
                <h4 className="text-foreground text-sm font-medium">
                  Transparent
                </h4>
            ...
            <div className="flex items-start gap-2.5">
              <HiLockClosed className="text-primary mt-0.5 h-5 w-5 flex-shrink-0" />
              <div>
                <h4 className="text-foreground text-sm font-medium">
                  Verified
                </h4>
