 ...
 *
 * NOTE on registrationDate, createdAt, updatedAt:
...
// In production, voters link to candidates through canvassers. In mock, all voters belong to the demo candidate.
export function getVotersByCandidateId(_candidateId: string): Voter[] {
  return [...voters];
}
