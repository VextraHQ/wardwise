...
- Shared IndexedDB plumbing in `src/features/collect/lib/offline/offline-storage.ts` so the queue store and geo-pack store share one connection and one version
