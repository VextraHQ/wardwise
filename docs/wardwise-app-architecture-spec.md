...
| Phase 5 - Geo Relocation                     | Next        | Move `src/components/admin/geo/*`, `use-geo`, `lib/geo/*`, `lib/api/{geo,location}.ts`, geo schemas. Watch static data and client bundle imports.                                                                                                                                                                                                                            |
