...
| `src/components/admin/admin-*`                                                                                                  | `src/features/admin-shell/components/*`, except reusable list/search/skeleton primitives now in `src/components/shared/admin/*`                  |
...
| `src/components/admin/shared/*` feature-aware geo/form composites                                                               | `src/features/admin-shell/components/shared/*` until they can be safely split from feature dependencies                                          |
...
- `src/components/admin/admin-*` -> `features/admin-shell/components` except reusable list/search/skeleton primitives promoted to `components/shared/admin`
- `src/components/admin/account/*` -> `features/admin-shell/components/account`
- `src/components/admin/shared/*` -> `features/admin-shell/components/shared`, with cross-feature admin list primitives promoted to `components/shared/admin`
